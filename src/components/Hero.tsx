        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="space-y-5 text-[#6B7280] text-sm leading-7">
                ...
                <p><span className="font-semibold text-[#1F2937]">学习能力：</span>学业成绩位居专业前 5%；美团招聘实习期间对接美团外卖BC端业务，并系统学习美团公开产品课程，搭建知识框架。</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              {/* 呼吸灯光圈 - 暗示在线/活跃 */}
              <div className="absolute inset-0 rounded-full border-2 border-[#4CAF50]/50 animate-breathe-glow" />
              <div className="absolute -inset-4 rounded-full border border-[#2196F3]/20 opacity-60" />
